...
#ifndef CONF_WEB_PARAMETER_h
#define CONF_WEB_PARAMETER_h
...
public:
  ...
  virtual void renderHtml(bool dataArrived, WebRequestWrapper* webRequestWrapper, String& content) = 0;
  virtual void renderHtml(bool dataArrived, String& content) = 0;
...
protected:
  ...
  void renderHtml(bool dataArrived, WebRequestWrapper* webRequestWrapper, String& content) override;
  void renderHtml(bool dataArrived, String& content) override;
...
/**
 * TextParameters is to store text based parameters.
 */
...
protected:
  ...
  virtual void renderHtml(bool dataArrived, WebRequestWrapper* webRequestWrapper, String& content) override;
  virtual void renderHtml(bool dataArrived, String& content) override;
